...
class TestSettingsManager:
    ...
    def test_anahtar_sabitleri(self):
        ...
        assert SettingsManager.KEY_EDUCATION_TARGET_PATH == "last_education_target_path"
        assert SettingsManager.KEY_EDUCATION_SOURCE_PATH == "last_education_source_path"
